...
// >>> Replace "secrets_manager_sdk" with the correct value for your project
...
public class SdkCommon {
    ...
    // >>> Replace "secrets-manager-sdk" with the parent project's artifactId (e.g. platform-services)
