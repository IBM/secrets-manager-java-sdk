...
public class SecretResourceArbitrarySecretResourceTest {
  ...
  public void testSecretResourceArbitrarySecretResource() throws Throwable {
    SecretResourceArbitrarySecretResource secretResourceArbitrarySecretResourceModel = new SecretResourceArbitrarySecretResource.Builder()
      ...
      .expirationDate(DateUtils.parseAsDateTime("Mon Apr 01 12:30:00 IDT 2030"))
      .payload("testString")
      .build();
    ...
    assertEquals(secretResourceArbitrarySecretResourceModel.expirationDate(), DateUtils.parseAsDateTime("Mon Apr 01 12:30:00 IDT 2030"));
    ...
    assertEquals(secretResourceArbitrarySecretResourceModelNew.expirationDate(), DateUtils.parseAsDateTime("Mon Apr 01 12:30:00 IDT 2030"));
