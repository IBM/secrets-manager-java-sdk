 ...
 */
package com.ibm.cloud.secrets_manager.v1;
...
import com.ibm.cloud.secrets_manager.v1.model.CollectionMetadata;
import com.ibm.cloud.secrets_manager.v1.model.CreateSecret;
import com.ibm.cloud.secrets_manager.v1.model.CreateSecretGroupOptions;
import com.ibm.cloud.secrets_manager.v1.model.CreateSecretOptions;
import com.ibm.cloud.secrets_manager.v1.model.DeleteSecretGroupOptions;
import com.ibm.cloud.secrets_manager.v1.model.DeleteSecretOptions;
import com.ibm.cloud.secrets_manager.v1.model.EngineConfigOneOf;
import com.ibm.cloud.secrets_manager.v1.model.EngineConfigOneOfIAMSecretEngineRootConfig;
import com.ibm.cloud.secrets_manager.v1.model.GetConfigOptions;
import com.ibm.cloud.secrets_manager.v1.model.GetPolicyOptions;
import com.ibm.cloud.secrets_manager.v1.model.GetSecret;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretGroupOptions;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretMetadataOptions;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretOptions;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretPoliciesOneOf;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretPoliciesOneOfGetSecretPolicyRotation;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretPoliciesOneOfGetSecretPolicyRotationResourcesItem;
import com.ibm.cloud.secrets_manager.v1.model.GetSecretPoliciesOneOfResourcesItem;
import com.ibm.cloud.secrets_manager.v1.model.ListAllSecretsOptions;
import com.ibm.cloud.secrets_manager.v1.model.ListSecretGroupsOptions;
import com.ibm.cloud.secrets_manager.v1.model.ListSecrets;
import com.ibm.cloud.secrets_manager.v1.model.ListSecretsOptions;
import com.ibm.cloud.secrets_manager.v1.model.PutConfigOptions;
import com.ibm.cloud.secrets_manager.v1.model.PutPolicyOptions;
import com.ibm.cloud.secrets_manager.v1.model.SecretActionOneOf;
import com.ibm.cloud.secrets_manager.v1.model.SecretActionOneOfDeleteCredentialsForIAMSecret;
import com.ibm.cloud.secrets_manager.v1.model.SecretActionOneOfRotateArbitrarySecretBody;
import com.ibm.cloud.secrets_manager.v1.model.SecretActionOneOfRotateUsernamePasswordSecretBody;
import com.ibm.cloud.secrets_manager.v1.model.SecretGroupDef;
import com.ibm.cloud.secrets_manager.v1.model.SecretGroupMetadataUpdatable;
import com.ibm.cloud.secrets_manager.v1.model.SecretGroupResource;
import com.ibm.cloud.secrets_manager.v1.model.SecretMetadata;
import com.ibm.cloud.secrets_manager.v1.model.SecretMetadataRequest;
import com.ibm.cloud.secrets_manager.v1.model.SecretPolicyRotation;
import com.ibm.cloud.secrets_manager.v1.model.SecretPolicyRotationRotation;
import com.ibm.cloud.secrets_manager.v1.model.SecretResource;
import com.ibm.cloud.secrets_manager.v1.model.SecretResourceArbitrarySecretResource;
import com.ibm.cloud.secrets_manager.v1.model.SecretResourceIAMSecretResource;
import com.ibm.cloud.secrets_manager.v1.model.SecretResourceUsernamePasswordSecretResource;
import com.ibm.cloud.secrets_manager.v1.model.SecretVersion;
import com.ibm.cloud.secrets_manager.v1.model.UpdateSecretGroupMetadataOptions;
import com.ibm.cloud.secrets_manager.v1.model.UpdateSecretMetadataOptions;
import com.ibm.cloud.secrets_manager.v1.model.UpdateSecretOptions;
...
public class SecretsManagerTest extends PowerMockTestCase {
    ...
    public void testPutPolicyWOptions() throws Throwable {
        ...
        // Invoke operation with valid options model (positive test)
        Response<GetSecretPoliciesOneOf> response = secretsManagerService.putPolicy(putPolicyOptionsModel).execute();
        assertNotNull(response);
    ...
    public void testGetPolicyWOptions() throws Throwable {
        ...
        // Invoke operation with valid options model (positive test)
        Response<GetSecretPoliciesOneOf> response = secretsManagerService.getPolicy(getPolicyOptionsModel).execute();
        assertNotNull(response);
        GetSecretPoliciesOneOf responseObj = response.getResult();
        assertNotNull(responseObj);
