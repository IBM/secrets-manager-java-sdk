...
/**
 * Unit test class for the PublicCertificateConfigurationDNSClassicInfrastructure model.
 */
public class PublicCertificateConfigurationDNSClassicInfrastructureTest {
  ...
  public void testPublicCertificateConfigurationDNSClassicInfrastructure() throws Throwable {
    ...
    assertNull(publicCertificateConfigurationDnsClassicInfrastructureModel.getUpdatedAt());
    assertNull(publicCertificateConfigurationDnsClassicInfrastructureModel.getClassicInfrastructureUsername());
    assertNull(publicCertificateConfigurationDnsClassicInfrastructureModel.getClassicInfrastructurePassword());
  }
}