...
/**
 * Unit test class for the CreateSecretVersionLocksBulkOptions model.
 */
public class CreateSecretVersionLocksBulkOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateSecretVersionLocksBulkOptions() throws Throwable {
  ...
  public void testCreateSecretVersionLocksBulkOptionsError() throws Throwable {
    new CreateSecretVersionLocksBulkOptions.Builder().build();
  }
