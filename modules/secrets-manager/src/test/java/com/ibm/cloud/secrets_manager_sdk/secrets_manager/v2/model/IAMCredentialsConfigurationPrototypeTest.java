...
/**
 * Unit test class for the IAMCredentialsConfigurationPrototype model.
 */
public class IAMCredentialsConfigurationPrototypeTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testIAMCredentialsConfigurationPrototype() throws Throwable {
    IAMCredentialsConfigurationPrototype iamCredentialsConfigurationPrototypeModel = new IAMCredentialsConfigurationPrototype.Builder()
    ...
    IAMCredentialsConfigurationPrototype iamCredentialsConfigurationPrototypeModelNew = TestUtilities.deserialize(json, IAMCredentialsConfigurationPrototype.class);
    assertTrue(iamCredentialsConfigurationPrototypeModelNew instanceof IAMCredentialsConfigurationPrototype);
  ...
  public void testIAMCredentialsConfigurationPrototypeError() throws Throwable {
    new IAMCredentialsConfigurationPrototype.Builder().build();
  }
