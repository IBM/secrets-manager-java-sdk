...
/**
 * Unit test class for the ServiceCredentialsSecretSourceServiceRO model.
 */
public class ServiceCredentialsSecretSourceServiceROTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testServiceCredentialsSecretSourceServiceRO() throws Throwable {
    ServiceCredentialsSecretSourceServiceRO serviceCredentialsSecretSourceServiceRoModel = new ServiceCredentialsSecretSourceServiceRO();
    assertNull(serviceCredentialsSecretSourceServiceRoModel.getInstance());
    assertNull(serviceCredentialsSecretSourceServiceRoModel.getParameters());
    assertNull(serviceCredentialsSecretSourceServiceRoModel.getRole());
    assertNull(serviceCredentialsSecretSourceServiceRoModel.getIam());
    assertNull(serviceCredentialsSecretSourceServiceRoModel.getResourceKey());
  }
}