...
public class CertificateValidityTest {
  ...
  public void testCertificateValidity() throws Throwable {
    CertificateValidity certificateValidityModel = new CertificateValidity();
    assertNull(certificateValidityModel.getNotBefore());
    assertNull(certificateValidityModel.getNotAfter());
  }
}