...
public class KVSecretMetadataTest {
  ...
  public void testKVSecretMetadata() throws Throwable {
    ...
    assertNull(kvSecretMetadataModel.getId());
    assertNull(kvSecretMetadataModel.getLabels());
    assertNull(kvSecretMetadataModel.getSecretGroupId());
    assertNull(kvSecretMetadataModel.getSecretType());
    assertNull(kvSecretMetadataModel.getUpdatedAt());
    assertNull(kvSecretMetadataModel.getVersionsTotal());
  }
}