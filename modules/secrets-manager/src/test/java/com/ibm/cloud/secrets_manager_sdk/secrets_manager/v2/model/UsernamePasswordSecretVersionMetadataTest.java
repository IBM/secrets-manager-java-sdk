 ...
 */
public class UsernamePasswordSecretVersionMetadataTest {
  ...
  public void testUsernamePasswordSecretVersionMetadata() throws Throwable {
    ...
    assertNull(usernamePasswordSecretVersionMetadataModel.getCreatedBy());
    assertNull(usernamePasswordSecretVersionMetadataModel.getCreatedAt());
    assertNull(usernamePasswordSecretVersionMetadataModel.getId());
    assertNull(usernamePasswordSecretVersionMetadataModel.getSecretType());
    assertNull(usernamePasswordSecretVersionMetadataModel.getSecretGroupId());
    assertNull(usernamePasswordSecretVersionMetadataModel.isPayloadAvailable());
