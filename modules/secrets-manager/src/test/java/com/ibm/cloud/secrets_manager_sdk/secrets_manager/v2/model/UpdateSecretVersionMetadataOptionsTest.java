...
public class UpdateSecretVersionMetadataOptionsTest {
  ...
  public void testUpdateSecretVersionMetadataOptions() throws Throwable {
    UpdateSecretVersionMetadataOptions updateSecretVersionMetadataOptionsModel = new UpdateSecretVersionMetadataOptions.Builder()
      ...
      .secretVersionMetadataPatch(java.util.Collections.singletonMap("anyKey", "anyValue"))
      .build();
    assertEquals(updateSecretVersionMetadataOptionsModel.secretId(), "0b5571f7-21e6-42b7-91c5-3f5ac9793a46");
    assertEquals(updateSecretVersionMetadataOptionsModel.id(), "eb4cf24d-9cae-424b-945e-159788a5f535");
    assertEquals(updateSecretVersionMetadataOptionsModel.secretVersionMetadataPatch(), java.util.Collections.singletonMap("anyKey", "anyValue"));
  }
