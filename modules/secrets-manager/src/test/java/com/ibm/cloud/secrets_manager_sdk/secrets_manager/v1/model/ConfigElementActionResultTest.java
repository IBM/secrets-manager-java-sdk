...
/**
 * Unit test class for the ConfigElementActionResult model.
 */
public class ConfigElementActionResultTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testConfigElementActionResult() throws Throwable {
    ConfigElementActionResult configElementActionResultModel = new ConfigElementActionResult();
    assertNull(configElementActionResultModel.getMetadata());
    assertNull(configElementActionResultModel.getResources());
  }
}