...
public class UpdateSecretMetadataOptionsTest {
    ...
    public void testUpdateSecretMetadataOptions() throws Throwable {
        UpdateSecretMetadataOptions updateSecretMetadataOptionsModel = new UpdateSecretMetadataOptions.Builder()
                ...
                .secretMetadataPatch(java.util.Collections.singletonMap("anyKey", "anyValue"))
                .build();
        assertEquals(updateSecretMetadataOptionsModel.id(), "0b5571f7-21e6-42b7-91c5-3f5ac9793a46");
        assertEquals(updateSecretMetadataOptionsModel.secretMetadataPatch(), java.util.Collections.singletonMap("anyKey", "anyValue"));
    }
