...
public class UsernamePasswordSecretMetadataTest {
  ...
  public void testUsernamePasswordSecretMetadata() throws Throwable {
    ...
    assertNull(usernamePasswordSecretMetadataModel.getId());
    assertNull(usernamePasswordSecretMetadataModel.getLabels());
    assertNull(usernamePasswordSecretMetadataModel.getSecretGroupId());
    assertNull(usernamePasswordSecretMetadataModel.getSecretType());
    assertNull(usernamePasswordSecretMetadataModel.getUpdatedAt());
