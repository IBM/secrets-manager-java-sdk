...
public class SecretLocksPager {
  ...
  protected ListSecretLocksOptions options;
  protected SecretsManager client;
  protected PageContext pageContext;

  // Hide the default ctor.
  protected SecretLocksPager() { }

  /**
   * Constructs a new SecretLocksPager instance with the specified client and options model instance.
   * @param client the SecretsManager instance to be used to invoke the "listSecretLocks" method
   * @param options the ListSecretLocksOptions instance to be used to invoke the "listSecretLocks" method
   */
  ...
  public List<SecretLock> getNext() {
    ...
    ListSecretLocksOptions.Builder builder = this.options.newBuilder();
    if (this.pageContext.getNext() != null) {
      builder.offset(this.pageContext.getNext());
    }
    this.options = builder.build();

    SecretLocksPaginatedCollection result = client.listSecretLocks(options).execute().getResult();
   ...
   * @return a List&lt;SecretLock&gt; containing all results returned by the "listSecretLocks" method
   */
